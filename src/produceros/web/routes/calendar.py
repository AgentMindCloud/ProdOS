...
async def new_deadline(
    ...
    if (
        ...
        and form.get("title")
        and form.get("due_date")
        and form.get("deadline_type")
    ):
        create_deadline(
            session,
            title=str(form["title"]),
            deadline_type=DeadlineType(str(form["deadline_type"])),
...
async def export_calendar(
    ...
    return PlainTextResponse(
        ...
        headers={"Content-Disposition": 'attachment; filename="produceros-calendar.ics"'},
    )
